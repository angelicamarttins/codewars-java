...
*/
  ...
  private final static Set<String> COLORS = new HashSet<>(Arrays.asList(
  ...
  public static String printerError(String s) {
    ...
    long errors = Arrays.stream(splittedString).filter(color -> !COLORS.contains(color)).count();

    return errors + "/" + splittedString.length;
  }
